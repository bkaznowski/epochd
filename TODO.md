...
- [ ] **Phase 20 — Controller restart recovery** (persist registry to ConfigMap; reload on startup)
- [ ] **Phase 21 — Graceful agent shutdown** (reset all handles on SIGTERM before exit)
